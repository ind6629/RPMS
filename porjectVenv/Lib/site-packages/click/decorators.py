...
@t.overload
def command(
    name: t.Optional[str], cls: t.Type[CmdType], **attrs: t.Any,
...
@t.overload
def command(
    name: None = None, *, cls: t.Type[CmdType], **attrs: t.Any,
) -> t.Callable[[_AnyCallable], CmdType]:
    ...
...
@t.overload
def group(
    name: t.Optional[str], cls: t.Type[GrpType], **attrs: t.Any,
...
@t.overload
def group(
    name: None = None, *, cls: t.Type[GrpType], **attrs: t.Any,
) -> t.Callable[[_AnyCallable], GrpType]:
    ...
...
class HelpOption(Option):
    ...
    def __init__(
        self, param_decls: t.Optional[t.Sequence[str]] = None, **kwargs: t.Any,
    ) -> None:
        if not param_decls:
            param_decls = ("--help",)
