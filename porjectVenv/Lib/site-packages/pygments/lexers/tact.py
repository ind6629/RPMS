...
class TactLexer(RegexLexer):
    ...
    tokens = {
        ...
        "struct-body-in": [(r"\{", Punctuation, "struct-body"),],
        "struct-body": [
            (r"\}", Punctuation, "#pop:2"),
            include("comments"),
        ...
        "contract-or-trait-body-in": [(r"\{", Punctuation, "contract-or-trait-body"),],
        ...
        "field-declaration-in": [(r"\b\w+", Name.Property, "field-declaration"),],
        "field-declaration": [
            (r";", Punctuation, "#pop"),
            include("comments"),
        ...
        "fun-arguments-in": [(r"\(", Punctuation, "fun-arguments"),],
        "fun-arguments": [
            (r"\)", Punctuation, "#pop"),
            include("comments"),
            include("string-in"),
        ...
        "block-declaration": [(r"\}", Punctuation, "#pop"), include("statements"),],
        "statements": [
            include("comments"),
            include("block-declaration-in"),
            include("expressions"),
        ...
        "annotation-argument": [(r"\w+", Name.Function.Magic),],
        "expressions": [
            include("comments"),
            include("type-annotation-in"),
            include("keywords"),
        ...
        "type-generic-in": [(r"<", Punctuation, "type-generic"),],
        "type-generic": [
            (r">", Punctuation, "#pop"),
            include("comments"),
            include("type-as-in"),
        ...
        "type-as-in": [(r"\b(as)(\s+)", bygroups(Keyword, Whitespace), "type-as"),],
        "type-as": [
            (r"(?=\{|\;|\=|\,|\)|\>)", Punctuation, "#pop"),
            include("comments"),
            (r"\b\w+", Keyword.Type),
