...
class LuauLexer(RegexLexer):
    ...
    tokens = {
        "root": [(r"#!.*", Comment.Hashbang, "base"), default("base"),],
        "ws": [
            (_comment_multiline, Comment.Multiline),
            (_comment_single, Comment.Single),
            (r"\s+", Whitespace),
        ...
        "ternary": [
            ...
            (words(("then", "elseif",), suffix=r"\b"), Operator.Reserved, "expression"),
            default("#pop"),
        ],
        "closing_brace_pop": [(r"\}", Punctuation, "#pop"),],
        "closing_parenthesis_pop": [(r"\)", Punctuation, "#pop"),],
        "closing_gt_pop": [(r">", Punctuation, "#pop"),],
        ...
        "closing_brace_base": [include("closing_brace_pop"), include("base"),],
        "closing_brace_type": [include("closing_brace_pop"), include("type"),],
        "closing_gt_type": [include("closing_gt_pop"), include("type"),],
        "string_escape": [
            (r"\\z\s*", String.Escape),
            (
